# Bubble Detector 구현 가이드 (개정 v2.0)
...
**중요: 각 검색에서 구체적 수치를 수집하세요**
- ❌ "VIX is at low levels" → 불충분
- ✅ "VIX is 15.3" → OK
...
### Step 5: 정성 조정 (상한 +3점, 엄격 기준)

**⚠️ CRITICAL: 정성 조정에는 MEASURABLE evidence가 필요합니다. 주관적 인상은 허용되지 않습니다.**
...
### 편향 방지
- Confirmation bias: 가설을 지지하는 정보만 수집
- Availability bias: 최근에 본 정보에 과가중
- Narrative fallacy: 스토리로 인과관계를 과도 단순화
