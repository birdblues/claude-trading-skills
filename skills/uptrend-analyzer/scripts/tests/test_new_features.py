...
import pytest
from helpers import make_sector_summary_row, make_full_sector_summary, make_timeseries_row
...
class TestGroupDivergence:
    ...
    def test_high_std_dev_flags(self):
        ...
        summary = make_full_sector_summary(
            ratios={
                "Technology": 0.50, "Consumer Cyclical": 0.10,
                "Communication Services": 0.30, "Financial": 0.30,
                "Industrials": 0.30,
            }
        )
    ...
    def test_high_spread_flags(self):
        ...
        summary = make_full_sector_summary(
            ratios={
                "Technology": 0.45, "Consumer Cyclical": 0.20,
                "Communication Services": 0.30, "Financial": 0.30,
                "Industrials": 0.30,
            }
        )
    ...
    def test_trend_dissenter_flags(self):
        ...
        summary = make_full_sector_summary(
            ratios={
                "Technology": 0.30, "Consumer Cyclical": 0.28,
                "Communication Services": 0.29, "Financial": 0.27,
                "Industrials": 0.30,
            },
            trends={
                "Technology": "Up", "Consumer Cyclical": "Up",
                "Communication Services": "Up", "Financial": "Down",
                "Industrials": "Up",
            }
        )
        sector_map = {s["Sector"]: s for s in summary}
    ...
    def test_no_divergence(self):
        ...
        summary = make_full_sector_summary(
            ratios={
                "Technology": 0.30, "Consumer Cyclical": 0.29,
                "Communication Services": 0.30, "Financial": 0.31,
                "Industrials": 0.30,
                "Utilities": 0.20, "Consumer Defensive": 0.21,
                "Healthcare": 0.20, "Real Estate": 0.21,
            }
        )
        sector_map = {s["Sector"]: s for s in summary}
        result = _calculate_group_divergence(sector_map)
    ...
    def test_no_divergence_zero_penalty(self):
        ...
        summary = make_full_sector_summary(
            ratios={
                "Technology": 0.30, "Consumer Cyclical": 0.30,
                "Communication Services": 0.30, "Financial": 0.30,
                "Industrials": 0.30,
                "Utilities": 0.20, "Consumer Defensive": 0.20,
                "Healthcare": 0.20, "Real Estate": 0.20,
            }
        )
        sector_map = {s["Sector"]: s for s in summary}
        result = _calculate_group_divergence(sector_map)
...
class TestWarningPenalties:
    ...
    def test_all_three_warnings(self):
        from scorer import _calculate_warning_penalties
        result = _calculate_warning_penalties({"late_cycle": True, "high_spread": True, "divergence": True})
        # -5 + -3 + -3 + 1 = -10
    ...
    def test_penalty_applied_to_composite(self):
        ...
        scores = {
            "market_breadth": 80, "sector_participation": 80,
            "sector_rotation": 80, "momentum": 80, "historical_context": 80,
        }
    ...
    def test_penalty_clamped_at_zero(self):
        ...
        from scorer import calculate_composite_score
        scores = {
            "market_breadth": 2, "sector_participation": 2,
            "sector_rotation": 2, "momentum": 2, "historical_context": 2,
        }
...
class TestHistoricalConfidence:
    ...
    def test_confidence_in_full_calculation(self):
        ...
        ts = [make_timeseries_row(ratio=0.10 + i * 0.01, date=f"2026-01-{i+1:02d}")
              for i in range(20)]
...
class TestDivergenceWarning:
    ...
    def test_divergence_warning_generated(self):
        ...
        zone_info = {
            "zone": "Bull", "color": "light_green",
            "exposure_guidance": "Normal Exposure (80-100%)",
            "guidance": "Test.", "actions": [],
        }
    ...
    def test_zone_detail_in_composite(self):
        ...
        from scorer import calculate_composite_score
        scores = {
            "market_breadth": 65, "sector_participation": 65,
            "sector_rotation": 65, "momentum": 65, "historical_context": 65,
        }
