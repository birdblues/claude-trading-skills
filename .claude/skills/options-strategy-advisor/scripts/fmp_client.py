#!/usr/bin/env python3
"""
FMP API Client for Options Strategy Advisor

Provides rate-limited access to Financial Modeling Prep API endpoints
for options analysis with yfinance fallback.

Features:
- Rate limiting (0.3s between requests)
- Automatic retry on 429 errors
- Session caching for duplicate requests
- yfinance fallback when FMP fails
"""
...
class FMPClient:
    """Client for Financial Modeling Prep API with rate limiting, caching, and yfinance fallback"""
    ...
    def get_historical_prices(self, symbol: str, days: int = 365) -> Optional[list[dict]]:
