...
- **Language**: Reports generated in Korean; technical terms and data preserved in English
...
4. **Korean Report**: 리포트를 한국어로 작성. 기술 용어와 데이터는 영어/원본 유지
...
**Language Note**: 리포트는 한국어로 작성. 기술 용어, 숫자, 시그널 상태는 영어 원본 유지.
...
**IMPORTANT**: 리포트를 한국어로 작성한다. 기술 용어와 데이터는 영어 원본 유지.
...
1. ✓ **Language**: Report content is in Korean; technical terms and data in English
...
- Write in professional, analytical Korean; technical terms in English
...
리포트를 한국어로 작성한다. `assets/breadth_analysis_template.ko.md` 템플릿을 사용한다.
종목 티커, 기술 지표명(8MA, 200MA 등), 숫자 데이터, 퍼센트, 시그널 상태(CONFIRMED/DEVELOPING/FAILED 등)는 영어/원본을 유지한다.
